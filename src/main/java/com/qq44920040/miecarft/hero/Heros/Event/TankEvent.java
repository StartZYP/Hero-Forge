...
implements Listener {
    private static final PotionEffect NODAMAGE = new PotionEffect(PotionEffectType.REGENERATION, 240, 2);
                ...
                for (World world : Bukkit.getWorlds()) {
                    for (Player player : world.getPlayers()) {
                        ...
                        if (player.hasPotionEffect(PotionEffectType.REGENERATION)) {
                            if (player.getPotionEffect(PotionEffectType.REGENERATION).getAmplifier() > NODAMAGE.getAmplifier()) continue;
